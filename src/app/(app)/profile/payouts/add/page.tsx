...
export default function AddPayoutAccountPage() {
  ...
  return (
    <div
      ...
      style={{ background: BG, color: "var(--c-text)", fontFamily: "var(--font-work-sans)" }}
    >
      {/* Aura glows */}
      ...
      >
        ...
        <h1 style={{ fontFamily: "var(--font-jersey25)", fontSize: 22, color: "var(--c-text)" }}>
          Add Payout Account
        </h1>
      </header>
      ...
      <main className="w-full max-w-2xl px-6 pt-24 pb-12 flex-1 flex flex-col">
        ...
        <section className="mb-8">
          <p className="text-[0.75rem] mb-4" style={{ color: MUTED, fontFamily: "var(--font-work-sans)" }}>
          ...
          >
            ...
            <p className="text-[0.6875rem]" style={{ color: GreenL, fontFamily: "var(--font-work-sans)" }}>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="space-y-2 relative">
            <label className="text-[0.8125rem] font-medium ml-4" style={{ color: MUTED, fontFamily: "var(--font-work-sans)" }}>
              Select Bank
            </label>
                ...
                {filtered.slice(0, 7).map((b) => (
                  <li key={b}>
                    <button
                      ...
                      style={{ color: "var(--c-text)", fontFamily: "var(--font-work-sans)" }}
          ...
          <div className="flex flex-col gap-4">
            ...
            {verifiedName && (
              <div className="flex items-center gap-3 px-4 py-2 rounded-xl" style={{ background: "rgba(130,219,126,0.07)" }}>
                ...
                <p className="text-[0.8125rem]" style={{ color: GreenL, fontFamily: "var(--font-work-sans)" }}>
          ...
          <div className="space-y-2" style={{ opacity: verifiedName ? 1 : 0.4 }}>
            ...
            <input
              ...
              style={{ background: "var(--c-bg)", color: MUTED, fontFamily: "var(--font-work-sans)", cursor: "default", border: "1px solid rgba(64,73,61,0.1)" }}
            />
          </div>
        ...
        <div className="mt-12 space-y-4">
          ...
          <button
            ...
            style={{ color: MUTED, fontFamily: "var(--font-work-sans)" }}
          >
            Cancel
          </button>
        </div>
