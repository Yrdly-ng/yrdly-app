...
export function NotificationsDropdown({ isOpen, onClose, onNotificationCountChange }: NotificationsDropdownProps) {
  ...
  return (
    <>
      ...
      <div 
        className="fixed top-20 right-4 lg:left-[272px] lg:right-auto lg:top-auto lg:bottom-16 lg:max-h-[70vh] lg:overflow-y-auto w-[320px] shadow-[0_20px_40px_rgba(0,0,0,0.6)] z-[110] overflow-hidden rounded-[11px]"
